...
import { QuestoBestAnswerChosenEvent } from '@/domain/forum/enterprise/events/question-best-answer-chosen-event'
...
export class OnQuestionBestAnswerChosen implements EventHandler {
  ...
  setupSubscriptions(): void {
    DomainEvents.register(
      ...
      QuestoBestAnswerChosenEvent.name,
    )
  }
